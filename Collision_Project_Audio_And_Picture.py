...
fish_sound = pygame.mixer.Sound("completetask_0.mp3")
...
player_width = 100
player_height = 72
player = Box(screen, raft.x, raft.y, player_width, player_height, BLACK, "Null")
enemy_width = 20
enemy_list = []
counter = 0
time_count = 0
...
for i in range(15):
    ...
    enemy_list.append(Box(screen, random_x, y_coord, enemy_width, enemy_width, OCEAN_BLUE_CLEAR, fish2))
while running:
